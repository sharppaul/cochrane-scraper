...
public class Getter {
	...
	//simple get method, with some added functionality for this program.
	public static String get(String urlToRead) throws Exception {
		...
		//if the request is made at the genderize.io API, we'll display the current usage and remaining time.
		...
		//attempt to retrieve file 3 times in case of errors.
		int attempts = 0;
